function selectText(t) {
    if (document.selection) {
        ...
        e.moveToElementText(document.getElementById(t)), e.select()
    } else if (window.getSelection) {
        var e = document.createRange();
        e.selectNode(document.getElementById(t)), window.getSelection().addRange(e)
    }
}
...
function checkTab(t) {
    document.all && 9 == event.keyCode && (t.selection = document.selection.createRange(), setTimeout("processTab('" + t.id + "')", 0))
}

function processTab(t) {
    document.all[t].selection.text = String.fromCharCode(9), document.all[t].focus()
}

function setSelectionRange(t, e, i) {
    if (t.setSelectionRange) t.focus(), t.setSelectionRange(e, i);
...
function replaceSelection(t, e) {
    if (t.setSelectionRange) {
        var i = t.selectionStart,
            o = t.selectionEnd;
        t.value = t.value.substring(0, i) + e + t.value.substring(o), i != o ? setSelectionRange(t, i, i + e.length) : setSelectionRange(t, i + e.length, i + e.length)
    } else if (document.selection) {
        var n = document.selection.createRange();
        if (n.parentElement() == t) {
            var s = "" == n.text;
            n.text = e, s || (n.moveStart("character", -e.length), n.select())
        }
    }
}

function catchTab(t, e) {
    if (navigator.userAgent.match("Gecko") ? c = e.which : c = e.keyCode, 9 == c) {
        var i = t.scrollTop;
        return replaceSelection(t, String.fromCharCode(9)), stopEvent(e), t.scrollTop = i, !1
    }
}

function stopEvent(t) {
    t.preventDefault && t.preventDefault(), t.stopPropagation && t.stopPropagation(), t.stopped = !0
}

function fliprows(t, e) {
    var i, o = document.getElementsByTagName("tr");
...
function highlight(t) {
    var e = js.textElement.caretPosition(t);
    if (e.start || e.end) {
        var i = js.text.getLines(js.textElement.value(t)),
            o = 0,
            n = 0,
            s = "",
            r = !1,
            a = 0;
        for (var l in i) {
            if (n = o + i[l].length, e.start >= o && e.start <= n && (r = !0), r) {
                var d = "@h@" == i[l].substr(0, 3);
                a || (a = d ? 1 : 2), 1 == a && d ? i[l] = i[l].substr(3, i[l].length - 3) : 2 != a || d || (s += "@h@")
            }
            s = s + i[l] + "\n", e.end >= o && e.end <= n && (r = !1), o = n + 1
        }
        t.value = s.substring(0, s.length - 1);
        var c = e.start + (1 == a ? -3 : 3);
        js.textElement.setCaretPosition(t, {
            start: c,
            end: c
        })
    }
...
function getElementsByClassName(t, e) {
    return t.getElementsByClassName ? t.getElementsByClassName(e) : function i(t, e) {
        null == e && (e = document);
        var o, n, i = [],
            s = e.getElementsByTagName("*"),
            r = s.length,
            a = new RegExp("(^|\\s)" + t + "(\\s|$)");
        for (o = 0, n = 0; r > o; o++) a.test(s[o].className) && (i[n] = s[o], n++);
        return i
    }(e, t)
}

function twitpopup(t) {
    window.open("http://twitter.com/share?url=https://pastebin.com" + t + "&via=pastebin", "tweet", "height=340,width=550,resizable=1")
}

function facebookpopup(t) {
    window.open("http://facebook.com/sharer.php?u=https://pastebin.com" + t, "facebook", "height=340,width=660,resizable=1")
}
var js = {
    text: {
        lines: function (t) {
            return this.getLines(t).length
        },
        getLines: function (t) {
            var e = t.split("\n");
            return e
    ...
    textElement: {
        ...
        caretPosition: function (t) {
            ...
            if (document.selection) {
                ...
                var n;
                for (n = 0; o.compareEndPoints("StartToStart", i) < 0; n++) o.moveStart("character", 1);
                e.start = n, e.end = n + i.text.replace(/\r/g, "").length
            } else(t.selectionStart || 0 == t.selectionStart) && (e.start = t.selectionStart, e.end = t.selectionEnd);
            return e
        },
        setCaretPosition: function (t, e) {
            if (t.focus(), t.setSelectionRange) t.setSelectionRange(e.start, e.end);
            else if (t.createTextRange) {
                var i = t.createTextRange();
                i.moveStart("character", e.start), i.moveEnd("character", e.end), i.select()
            }
        }
    }
};
! function (t, e) {
    ...
    function i(t) {
        function e() {
            ...
            h = e.overflowY, "vertical" === e.resize ? t.style.resize = "none" : "both" === e.resize && (t.style.resize = "horizontal"), u = "content-box" === e.boxSizing ? -(parseFloat(e.paddingTop) + parseFloat(e.paddingBottom)) : parseFloat(e.borderTopWidth) + parseFloat(e.borderBottomWidth), isNaN(u) && (u = 0), n()
        }

        function i(e) {
            var i = t.style.width;
            t.style.width = "0px", t.offsetWidth, t.style.width = i, h = e, c && (t.style.overflowY = e), o()
        }
        ...
        function o() {
            ...
            return 0 === t.scrollHeight ? void(t.style.height = o) : (t.style.height = n + "px", p = t.clientWidth, document.documentElement.scrollTop = e, void(document.body.scrollTop = i))
        }
        ...
        function n() {
            ...
            if (n.height !== t.style.height ? "visible" !== h && i("visible") : "hidden" !== h && i("hidden"), e !== t.style.height) {
        ...
        if (t && t.nodeName && "TEXTAREA" === t.nodeName && !s.has(t)) {
            var u = null,
                ...
                g = function (e) {
                    window.removeEventListener("resize", f), t.removeEventListener("input", n), t.removeEventListener("keyup", n), t.removeEventListener("autosize:destroy", g), s["delete"](t), Object.keys(e).forEach(function (i) {
                        t.style[i] = e[i]
                    })
                }.bind(t, {
            ...
            t.addEventListener("autosize:destroy", g), "onpropertychange" in t && "oninput" in t && t.addEventListener("keyup", n), window.addEventListener("resize", f), t.addEventListener("input", n), t.addEventListener("autosize:update", n), s.add(t), l && (t.style.overflowX = "hidden", t.style.wordWrap = "break-word"), e()
        }
    }
    ...
    "undefined" == typeof window || "function" != typeof window.getComputedStyle ? (r = function (t) {
        ...
        t(window).scroll(function () {
            t(this).scrollTop() > e ? n.addClass("cd-is-visible") : n.removeClass("cd-is-visible cd-fade-out"), t(this).scrollTop() > i && n.addClass("cd-fade-out")
    ...
    function (t) {
        ...
        function e(e, o) {
            ...
            return "area" === a ? (n = e.parentNode, s = n.name, e.href && s && "map" === n.nodeName.toLowerCase() ? (r = t("img[usemap='#" + s + "']")[0], !!r && i(r)) : !1) : (/^(input|select|textarea|button|object)$/.test(a) ? !e.disabled : "a" === a ? e.href || o : o) && i(e)
        }
        ...
        t.ui = t.ui || {}, t.extend(t.ui, {
            ...
            add: function (e, i, o) {
                var n, s = t.ui[e].prototype;
                for (n in o) s.plugins[n] = s.plugins[n] || [], s.plugins[n].push([i, o[n]])
            },
            call: function (t, e, i, o) {
                var n, s = t.plugins[e];
                if (s && (o || t.element[0].parentNode && 11 !== t.element[0].parentNode.nodeType))
        ...
        t.cleanData = function (e) {
            ...
            var n, s, r, a, l = {},
                d = e.split(".")[0];
            return e = e.split(".")[1], n = d + "-" + e, o || (o = i, i = t.Widget), t.expr[":"][n.toLowerCase()] = function (e) {
                return !!t.data(e, n)
                ...
                _proto: t.extend({}, o),
                _childConstructors: []
            }), a = new i, a.options = t.widget.extend({}, a.options), t.each(o, function (e, o) {
            ...
            _trigger: function (e, i, o) {
                ...
                if (o = o || {}, i = t.Event(i), i.type = (e === this.widgetEventPrefix ? e : this.widgetEventPrefix + e).toLowerCase(), i.target = this.element[0], s = i.originalEvent)
            ...
            t.position = {
                    scrollbarWidth: function () {
                        ...
                        var e, i, o = t("<div style='display:block;position:absolute;width:50px;height:50px;overflow:hidden;'><div style='height:100px;width:auto;'></div></div>"),
                            s = o.children()[0];
                        return t("body").append(o), e = s.offsetWidth, o.css("overflow", "scroll"), i = s.offsetWidth, e === i && (i = o[0].clientWidth), o.remove(), n = e - i
                    },
                    getScrollInfo: function (e) {
                        var i = e.isWindow || e.isDocument ? "" : e.element.css("overflow-x"),
                            o = e.isWindow || e.isDocument ? "" : e.element.css("overflow-y"),
                            n = "scroll" === i || "auto" === i && e.width < e.element[0].scrollWidth,
                            s = "scroll" === o || "auto" === o && e.height < e.element[0].scrollHeight;
                        return {
                    ...
                    getWithinInfo: function (e) {
                        ...
                        return {
                            ...
                            width: o || n ? i.width() : i.outerWidth(),
                            height: o || n ? i.height() : i.outerHeight()
                        }
                    }
                }, t.fn.position = function (n) {
                    if (!n || !n.of) return f.apply(this, arguments);
                    n = t.extend({}, n);
                    var p, g, v, m, b, y, w = t(n.of),
                        _ = t.position.getWithinInfo(n.within),
                        E = t.position.getScrollInfo(_),
                        x = (n.collision || "flip").split(" "),
                        C = {};
                    return y = o(w), w[0].preventDefault && (n.at = "left top"), g = y.width, v = y.height, m = y.offset, b = t.extend({}, m), t.each(["my", "at"], function () {
                        var t, e, i = (n[this] || "").split(" ");
                        1 === i.length && (i = d.test(i[0]) ? i.concat(["center"]) : c.test(i[0]) ? ["center"].concat(i) : ["center", "center"]), i[0] = d.test(i[0]) ? i[0] : "center", i[1] = c.test(i[1]) ? i[1] : "center", t = u.exec(i[0]), e = u.exec(i[1]), C[this] = [t ? t[0] : 0, e ? e[0] : 0], n[this] = [h.exec(i[0])[0], h.exec(i[1])[0]]
                    }), 1 === x.length && (x[1] = x[0]), "right" === n.at[0] ? b.left += g : "center" === n.at[0] && (b.left += g / 2), "bottom" === n.at[1] ? b.top += v : "center" === n.at[1] && (b.top += v / 2), p = e(C.at, g, v), b.left += p[0], b.top += p[1], this.each(function () {
                        var o, d, c = t(this),
                            u = c.outerWidth(),
                            h = c.outerHeight(),
                            f = i(this, "marginLeft"),
                            y = i(this, "marginTop"),
                            T = u + f + i(this, "marginRight") + E.width,
                            k = h + y + i(this, "marginBottom") + E.height,
                            W = t.extend({}, b),
                            N = e(C.my, c.outerWidth(), c.outerHeight());
                        "right" === n.my[0] ? W.left -= u : "center" === n.my[0] && (W.left -= u / 2), "bottom" === n.my[1] ? W.top -= h : "center" === n.my[1] && (W.top -= h / 2), W.left += N[0], W.top += N[1], s || (W.left = l(W.left), W.top = l(W.top)), o = {
                            marginLeft: f,
                            marginTop: y
                        }, t.each(["left", "top"], function (e, i) {
                            t.ui.position[x[e]] && t.ui.position[x[e]][i](W, {
                                targetWidth: g,
                                targetHeight: v,
                                elemWidth: u,
                                elemHeight: h,
                            ...
                            u > g && a(e + i) < g && (l.horizontal = "center"), h > v && a(o + s) < v && (l.vertical = "middle"), r(a(e), a(i)) > r(a(o), a(s)) ? l.important = "horizontal" : l.important = "vertical", n.using.call(this, t, l)
                        }), c.offset(t.extend(W, {
                            using: d
                        }))
                    })
                    ...
                    fit: {
                        left: function (t, e) {
                            var i, o = e.within,
                                ...
                                l = n - a,
                                d = a + e.collisionWidth - s - n;
                            e.collisionWidth > s ? l > 0 && 0 >= d ? (i = t.left + l + e.collisionWidth - s - n, t.left += l - i) : d > 0 && 0 >= l ? t.left = n : l > d ? t.left = n + s - e.collisionWidth : t.left = n : l > 0 ? t.left += l : d > 0 ? t.left -= d : t.left = r(t.left - a, t.left)
                        },
                        top: function (t, e) {
                            var i, o = e.within,
                                ...
                                l = n - a,
                                d = a + e.collisionHeight - s - n;
                            e.collisionHeight > s ? l > 0 && 0 >= d ? (i = t.top + l + e.collisionHeight - s - n, t.top += l - i) : d > 0 && 0 >= l ? t.top = n : l > d ? t.top = n + s - e.collisionHeight : t.top = n : l > 0 ? t.top += l : d > 0 ? t.top -= d : t.top = r(t.top - a, t.top)
                        }
                    },
                    flip: {
                        left: function (t, e) {
                            var i, o, n = e.within,
                                ...
                                c = d - l,
                                u = d + e.collisionWidth - r - l,
                                h = "left" === e.my[0] ? -e.elemWidth : "right" === e.my[0] ? e.elemWidth : 0,
                                p = "left" === e.at[0] ? e.targetWidth : "right" === e.at[0] ? -e.targetWidth : 0,
                                f = -2 * e.offset[0];
                            0 > c ? (i = t.left + h + p + f + e.collisionWidth - r - s, (0 > i || i < a(c)) && (t.left += h + p + f)) : u > 0 && (o = t.left - e.collisionPosition.marginLeft + h + p + f - l, (o > 0 || a(o) < u) && (t.left += h + p + f))
                        },
                        top: function (t, e) {
                            var i, o, n = e.within,
                                ...
                                c = d - l,
                                u = d + e.collisionHeight - r - l,
                                h = "top" === e.my[1],
                                p = h ? -e.elemHeight : "bottom" === e.my[1] ? e.elemHeight : 0,
                                f = "top" === e.at[1] ? e.targetHeight : "bottom" === e.at[1] ? -e.targetHeight : 0,
                                g = -2 * e.offset[1];
                            0 > c ? (o = t.top + p + f + g + e.collisionHeight - r - s, (0 > o || o < a(c)) && (t.top += p + f + g)) : u > 0 && (i = t.top - e.collisionPosition.marginTop + p + f + g - l, (i > 0 || a(i) < u) && (t.top += p + f + g))
                        }
                    },
                    flipfit: {
                        left: function () {
                ...
                function () {
                    var e, i, o, n, r, a = document.getElementsByTagName("body")[0],
                    ...
                    e.appendChild(l), i = a || document.documentElement, i.insertBefore(e, i.firstChild), l.style.cssText = "position: absolute; left: 10.7432222px;", n = t(l).offset().left, s = n > 10 && 11 > n, e.innerHTML = "", i.removeChild(e)
                }()
        }();
        t.ui.position, t.widget("ui.tooltip", {
            ...
            _addDescribedBy: function (e, i) {
                ...
                o.push(i), e.data("ui-tooltip-id", i).attr("aria-describedby", t.trim(o.join(" ")))
            },
            _removeDescribedBy: function (e) {
                var i = e.data("ui-tooltip-id"),
                    o = (e.attr("aria-describedby") || "").split(/\s+/),
                    n = t.inArray(i, o); - 1 !== n && o.splice(n, 1), e.removeData("ui-tooltip-id"), o = t.trim(o.join(" ")), o ? e.attr("aria-describedby", o) : e.removeAttr("aria-describedby")
            },
            _create: function () {
                this._on({
                    mouseover: "open",
            ...
            _setOption: function (e, i) {
                ...
                return "disabled" === e ? (this[i ? "_disable" : "_enable"](), void(this.options[e] = i)) : (this._super(e, i), void("content" === e && t.each(this.tooltips, function (t, e) {
                    o._updateContent(e.element)
                })))
            },
            _disable: function () {
                var e = this;
                t.each(this.tooltips, function (i, o) {
                    var n = t.Event("blur");
                    n.target = n.currentTarget = o.element[0], e.close(n, !0)
            ...
            open: function (e) {
                var i = this,
                    o = t(e ? e.target : this.element).closest(this.options.items);
                o.length && !o.data("ui-tooltip-id") && (o.attr("title") && o.data("ui-tooltip-title", o.attr("title")), o.data("ui-tooltip-open", !0), e && "mouseover" === e.type && o.parents().each(function () {
                    var e, o = t(this);
                    o.data("ui-tooltip-open") && (e = t.Event("blur"), e.target = e.currentTarget = this, i.close(e, !0)), o.attr("title") && (o.uniqueId(), i.parents[this.id] = {
                        element: this,
                        title: o.attr("title")
                    }, o.attr("title", ""))
                }), this._registerCloseHandlers(e, o), this._updateContent(o, e))
            },
            _updateContent: function (t, e) {
                var i, o = this.options.content,
                    n = this,
                    s = e ? e.type : null;
                return "string" == typeof o ? this._open(e, t, o) : (i = o.call(t[0], function (i) {
                    n._delay(function () {
            ...
            _open: function (e, i, o) {
                function n(t) {
                    d.of = t, r.is(":hidden") || r.position(d)
                }
                var s, r, a, l, d = t.extend({}, this.options.position);
                if (o) {
                    if (s = this._find(i)) return void s.tooltip.find(".ui-tooltip-content").html(o);
                    i.is("[title]") && (e && "mouseover" === e.type ? i.attr("title", "") : i.removeAttr("title")), s = this._tooltip(i), r = s.tooltip, this._addDescribedBy(i, r.attr("id")),
                        r.find(".ui-tooltip-content").html(o), this.liveRegion.children().hide(), o.clone ? (l = o.clone(), l.removeAttr("id").find("[id]").removeAttr("id")) : l = o, t("<div>").html(l).appendTo(this.liveRegion), this.options.track && e && /^mouse/.test(e.type) ? (this._on(this.document, {
                            mousemove: n
                            ...
                            r.is(":visible") && (n(d.of), clearInterval(a))
                ...
                var o = {
                    keyup: function (e) {
                        if (e.keyCode === t.ui.keyCode.ESCAPE) {
                            var o = t.Event(e);
                            o.currentTarget = i[0], this.close(o, !0)
                        }
                    }
                };
            ...
            close: function (e) {
                var i, o = this,
                    ...
                    s = this._find(n);
                return s ? (i = s.tooltip, void(s.closing || (clearInterval(this.delayedShow), n.data("ui-tooltip-title") && !n.attr("title") && n.attr("title", n.data("ui-tooltip-title")), this._removeDescribedBy(n), s.hiding = !0, i.stop(!0), this._hide(i, this.options.hide, function () {
                    o._removeTooltip(t(this))
                }), n.removeData("ui-tooltip-open"), this._off(n, "mouseleave focusout keyup"), n[0] !== this.element[0] && this._off(n, "remove"), this._off(this.document, "mousemove"), e && "mouseleave" === e.type && t.each(this.parents, function (e, i) {
                    t(i.element).attr("title", i.title), delete o.parents[e]
            ...
            _tooltip: function (e) {
                ...
                return t("<div>").addClass("ui-tooltip-content").appendTo(i), i.appendTo(this.document[0].body), this.tooltips[o] = {
                    element: e,
                    tooltip: i
                }
            },
        ...
        function e(e, n) {
            var s = e ? t(this) : n,
                r = t(s.attr("data-jq-dropdown")),
                a = s.hasClass("jq-dropdown-open");
            if (e) {
                if (t(e.target).hasClass("jq-dropdown-ignore")) return;
                e.preventDefault(), e.stopPropagation()
            } else if (s !== n.target && t(n.target).hasClass("jq-dropdown-ignore")) return;
            i(), a || s.hasClass("jq-dropdown-disabled") || (s.addClass("jq-dropdown-open"), r.data("jq-dropdown-trigger", s).show(), o(), r.trigger("show", {
                jqDropdown: r,
                trigger: s
            }))
        }
        ...
        function i(e) {
            var i = e ? t(e.target).parents().addBack() : null;
            if (i && i.is(".jq-dropdown")) {
                if (!i.is(".jq-dropdown-menu")) return;
                if (!i.is("A")) return
            }
        ...
        function o() {
            {
                var e = t(".jq-dropdown:visible").eq(0),
                    i = e.data("jq-dropdown-trigger"),
                    o = i ? parseInt(i.attr("data-horizontal-offset") || 0, 10) : null;
                i ? parseInt(i.attr("data-vertical-offset") || 0, 10) : null
            }
            0 !== e.length && i && e.css({
                left: e.hasClass("jq-dropdown-anchor-right") ? i.offset().left - (e.outerWidth() - i.outerWidth()) + 5 : i.offset().left + o
            })
        }
        t.extend(t.fn, {
            jqDropdown: function (o, n) {
                switch (o) {
                    case "show":
                    ...
                    case "detach":
                        return i(), t(this).removeAttr("data-jq-dropdown");
                    case "disable":
                        return t(this).addClass("jq-dropdown-disabled");
                    case "enable":
                        return i(), t(this).removeClass("jq-dropdown-disabled")
                }
            }
        }), t(document).on("mouseenter.jq-dropdown", "[data-jq-dropdown]", e), t(document).on("click.jq-dropdown", "[data-jq-dropdown]", e), t(document).on("click.jq-dropdown", i), t(window).on("resize", o)
    }(jQuery);
